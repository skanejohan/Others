...
class AnagramsSuite extends FunSuite {
  ...
  test("combinations: b") {
    ...
    assert(combinations(b).toSet === bcomb.toSet)
  }
  ...
  test("combinations: easy") {
    val easy = List(('a',1), ('e',1), ('s',1), ('y',1))
    val easyComb = List(
      List(),
      List(('a', 1)),
      List(('a', 1), ('e', 1)),
    ...
    assert(combinations(easy).toSet === easyComb.toSet)
  }
