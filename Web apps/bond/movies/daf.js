    ...
    locations: [
        {
            id: "hotel_du_cap",
			name: "Hotel du Cap",
            position: new google.maps.LatLng(43.547762, 7.118418),
        ...
        },
        {
            id: "pendleton",
			name: "Camp Pendleton",
            position: new google.maps.LatLng(33.214565, -117.387323),
...

        {
            ...
            position: new google.maps.LatLng(51.116817, 1.315723),
        ...
        },
        {
            id: "skinny_bridge",
			name: "Magere Brug",
            position: new google.maps.LatLng(52.363577, 4.902455),
        ...
        },
        {
            id: "whistler",
			name: "",
            position: new google.maps.LatLng(52.363851, 4.901582),
        ...
        },
        {
            id: "amstel",
			name: "",
            position: new google.maps.LatLng(52.362663, 4.902055),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(52.363421, 4.896150),
        ...
        },
        {
            id: "keizersgracht",
			name: "",
            position: new google.maps.LatLng(52.363579, 4.895957),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(52.363770, 4.895769),
        ...
        },
        {
            id: "theme_building",
			name: "Theme Building",
            position: new google.maps.LatLng(33.944157, -118.402494),
        ...
        },
        {
            id: "slumber",
			name: "Slumber, Inc.",
            position: new google.maps.LatLng(36.027636, -114.967330),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.184583, -115.136154),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.099704, -115.171653),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.136146, -115.151695),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.137755, -115.165231),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.145417, -115.156483),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(33.836944, -116.552310),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.086045, -115.148433),
        ...
        },
        {
            id: "gas",
			name: "Gas station",
            position: new google.maps.LatLng(36.135891, -115.155023),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.135353, -115.155032),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.132155, -115.152414),
        ...
        },
        {
            id: "dunes",
			name: "Dunes hotel",
            position: new google.maps.LatLng(36.112645, -115.177082),
        ...
        },
        {
            id: "tectronics",
			name: "Tectronics",
            position: new google.maps.LatLng(36.225902, -114.876266),
        ...
        },
        {
            id: "lvclub",
			name: "Las Vegas Club",
            position: new google.maps.LatLng(36.171685, -115.146017),
        ...
        },
        {
            id: "mint",
			name: "The Mint",
            position: new google.maps.LatLng(36.171263, -115.144855),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(36.171079, -115.144445),
        ...
        },
        {
            id: "nugget",
			name: "Golden Nugget",
            position: new google.maps.LatLng(36.170779, -115.144611),
        ...
        },
        {
            id: "fremont",
			name: "Fremont hotel",
            position: new google.maps.LatLng(36.170571, -115.143302),
        ...
        },
        {
            id: "pioneer",
			name: "Pioneer",
            position: new google.maps.LatLng(36.171136, -115.145426),
            description: "Pioneer",
            sources: [], 
        },
        {
            id: "golden_gate",
			name: "Golden Gate",
            position: new google.maps.LatLng(36.171502, -115.146124),
        ...
        },
        {
            id: "2nd",
			name: "Second Street",
            position: new google.maps.LatLng(36.170325, -115.144384),
        ...
        },
        {
            id: "alley",
			name: "Alley",
            position: new google.maps.LatLng(36.170173, -115.144272),
            description: "Alley",
            sources: [], 
        },
        {
            id: "lost_alley",
			name: "Lost alley",
            position: new google.maps.LatLng(36.170630, -115.145623),
        ...
        },
        {
            id: "landmark",
			name: "Landmark hotel",
            position: new google.maps.LatLng(36.133051, -115.155473),
        ...
        },
        {
            ...
            position: new google.maps.LatLng(33.793283, -116.510965),
        ...
        },
        {
            id: "oil_rig",
            name: "Oil rig",
            position: new google.maps.LatLng(33.137172, -117.465517),
            description: "Oil rig",
            sources: [], 
        },
        {
            id: "southampton",
            name: "Southampton",
            position: new google.maps.LatLng(50.904183, -1.426977),
